...
/* Wait for all the content to load - especially the data from loadmatchups.js 
*  and then add this script to each table head "th" element in the table.
*/


document.querySelectorAll(".matchup-table th").forEach(headerCell => {
